...
include RDIR . '/client/jquery/freichat_themes/' . $config->freichat_theme . '/argument.php';
...
border-bottom:none;
border-right:none;
background-image:url('<?php echo $config->freichat_theme; ?>/<?php echo $frei_tools_optionsimg; ?>');
}
...
border-bottom:none;
border-right:none;
background-image:url('<?php echo $config->freichat_theme; ?>/<?php echo $frei_optionsimg; ?>');
font-weight:normal;
padding-bottom:15px;
padding-left:4px;
}
...
cursor: text;
background: url(<?php echo $config->freichat_theme . "/search.jpg"; ?>) no-repeat;
margin: 0px;
color: #999;
outline: 0;
}
...
.chatboxcontent {
background-image:url('<?php echo $config->freichat_theme; ?>/<?php echo $bmidimg; ?>');
...
position:absolute;
color:white;
background-image:url('<?php echo $config->freichat_theme; ?>/<?php echo $freismileyimg; ?>');
/*overflow:auto;
